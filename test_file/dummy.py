...
from src.chess_zero.agent.player_chess import ChessPlayer
from src.chess_zero.config import Config
from src.chess_zero.env.chess_env import ChessEnv, Winner
from src.chess_zero.lib.data_helper import get_game_data_filenames, write_game_data_to_file, pretty_print
from src.chess_zero.lib.model_helper import load_best_model_weight, save_as_best_model, \
...
for i in range(7):
    data_path = f"./alpha_zero/datasets/iter{13}/"
    datasets = []
