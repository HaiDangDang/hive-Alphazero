...
# from hive_gym import HiveBoard

class Game_State:

    def __init__(self, tiles=[], white_inventory=None, black_inventory=None, render=True):
        ...
        self.piece_sets = white_inventory.piece_sets + black_inventory.piece_sets
